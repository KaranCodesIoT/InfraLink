...
import {
  ...
  Smartphone, ShieldCheck, MoreVertical
} from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto py-8 px-4 sm:px-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-500">Manage your connected payment methods and transaction history.</p>
        </div>
        <button
      ...
      <div className="flex space-x-1 bg-gray-100 p-1 rounded-xl w-fit mb-8">
        ...
        <button
          ...
          className={`px-5 py-2 text-sm font-semibold rounded-lg transition-all ${
            activeTab === 'methods' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
          }`}
        >
          Payment Methods
        </button>
          ...
          {loading && payments.length === 0 ? (
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              {payments.map((p) => {
                ...
                return (
                  <div key={p._id} className="grid grid-cols-12 gap-4 px-6 py-4 border-b border-gray-50 hover:bg-gray-50/50 transition items-center">
                    <div className="col-span-1">
                      <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${isSent ? 'bg-red-50' : 'bg-emerald-50'}`}>
                        {isSent ? <ArrowUpRight className="w-4 h-4 text-red-500" /> : <ArrowDownLeft className="w-4 h-4 text-emerald-500" />}
                      </div>
                    </div>
                    <div className="col-span-3 min-w-0">
                      <p className="text-sm font-medium text-gray-900 truncate">{p.description || (isSent ? 'Payment sent' : 'Payment received')}</p>
           ...
           <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <button className="bg-gray-50 border-2 border-dashed border-gray-200 rounded-2xl p-5 flex flex-col items-center justify-center text-gray-500 hover:bg-gray-100 hover:border-gray-300 hover:text-gray-700 transition-all group min-h-[120px]">
                <PlusCircle className="w-5 h-5 text-indigo-600 mb-2" />
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-5 rounded-2xl shadow-lg relative text-white overflow-hidden">
                ...
                <div className="flex justify-between items-center mt-6">
                  <div>
                    ...
                    <p className="text-sm font-medium font-mono">12 / 28</p>
                  </div>
                </div>
              </div>
              <button className="bg-gray-50 border-2 border-dashed border-gray-200 rounded-2xl p-5 flex flex-col items-center justify-center text-gray-500 hover:bg-gray-100 hover:border-gray-300 hover:text-gray-700 transition-all group min-h-[180px]">
                <PlusCircle className="w-5 h-5 text-orange-600 mb-2" />
