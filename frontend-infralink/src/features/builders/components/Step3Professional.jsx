...
export default function Step3Professional() {
  ...
  const addProject = () => {
    setFormData({
      pastProjects: [...formData.pastProjects, { title: '', description: '', location: '' }]
    });
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 h-[380px] overflow-y-auto">
          <div className="flex justify-between items-center mb-4">
            <label className="block text-sm font-semibold text-gray-800">Past Projects</label>
            <button
              type="button"
              onClick={addProject}
          ...
          {formData.pastProjects.length === 0 ? (
            ...
            <div className="space-y-4">
              {formData.pastProjects.map((project, index) => (
                <div key={index} className="bg-white p-4 rounded-md shadow-sm border border-gray-200 relative">
                  <button
                    type="button"
                  ...
                  <div className="space-y-3">
                    <input
                      ...
                      className="block w-full text-sm border-gray-300 rounded-md focus:ring-indigo-500 border p-2"
                      required
                    />
                    <textarea
