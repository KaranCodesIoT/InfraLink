      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-6">
        <div className="p-6 md:p-8 border-b border-gray-100 flex flex-col md:flex-row md:items-start justify-between gap-6">
          ...
          <div className="text-left md:text-right">
            ...
            {project.arModelUrl ? (
              <button
                onClick={() => navigate(`/ar-view/${project._id}`)}
              ...
              <div className="mt-3 flex items-center justify-center gap-2 w-full md:w-auto px-6 py-2.5 bg-gray-100 text-gray-500 rounded-xl font-medium border border-gray-200 cursor-not-allowed">
                <ImageIcon className="w-4 h-4" /> Only images available
              </div>
            )}
          </div>
        </div>
