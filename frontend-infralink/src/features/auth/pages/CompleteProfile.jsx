...
export default function CompleteProfile() {
  ...
  const validate = () => {
    ...
    if (user?.role === 'architect' && !form.professionType) newErrors.professionType = 'Type of Profession is required.';
    setErrors(newErrors);
  ...
  const handleSubmit = async (e) => {
    ...
    if (user.role === 'architect') {
      payload.professionType = form.professionType;
    }
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-lg">
        <div className="bg-white py-8 px-6 shadow sm:rounded-2xl sm:px-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Type of Profession (Only for Architects) */}
            {user.role === 'architect' && (
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Type of Profession <span className="text-red-500">*</span>
                </label>
                <div className="relative">
                  ...
                  <select
                    ...
                    className={`w-full pl-9 pr-3 py-2.5 border rounded-lg text-sm appearance-none focus:outline-none focus:ring-2 focus:ring-orange-500 transition-colors ${
                      errors.professionType ? 'border-red-400 bg-red-50' : 'border-gray-300'
                    }`}
                  >
                ...
                {errors.professionType && <p className="text-xs text-red-500 mt-1">{errors.professionType}</p>}
              </div>
            )}
